  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'registration', detail: { label: 'Registration', iconClass: 'oj-ux-ico-fire' } },
        { path: 'forgetpass', detail: { label: 'ForgetPass', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'user', detail: { label: 'User', iconClass: 'oj-ux-ico-information-group' } },
        { path: 'admin', detail: { label: 'Admin', iconClass: 'oj-ux-ico-information-chart' } },
        { path: 'branch', detail: { label: 'Branch Tab', iconClass: 'oj-ux-ico-information-chart' } },
        { path: 'sites', detail: { label: 'Sites Tab', iconClass: 'oj-ux-ico-information-chart' } },
